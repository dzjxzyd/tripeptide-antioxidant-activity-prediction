...
print(sum)
# ['PALJ810113', 'ONEK900102', 'FUKS010101', 'JOND750102', 'LIFS790103', 'MCMT640101', 'NAKH920102', 'OOBM850102', 'WEBA780101', 'VINM940102', 'PARS000101', 'PARS000102', 'FODM020101', 'MITS020101', 'DIGM050101']




#note: the X12 means the 13th features,
rf.feature_importances_[141]
rf.feature_importances_[285]
rf.feature_importances_[300]
rf.feature_importances_[769]
rf.feature_importances_[787]
rf.feature_importances_[793]
rf.feature_importances_[805]
rf.feature_importances_[814]
rf.feature_importances_[935]
rf.feature_importances_[970]
rf.feature_importances_[975]
rf.feature_importances_[976]
rf.feature_importances_[978]
rf.feature_importances_[991]
rf.feature_importances_[1011]
...
summary.to_csv('new_RandomForest_SfromModel_.csv')
