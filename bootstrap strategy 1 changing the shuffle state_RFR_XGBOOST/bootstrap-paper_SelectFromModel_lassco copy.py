...
array(['x105', 'x115', 'x164', 'x434', 'x717', 'x814', 'x935', 'x991'],
      dtype=object)
...
rf.coef_[935]
rf.coef_[991]
type(sfm.get_feature_names_out())
...
print(sum)
# ['MAXF760103', 'NAKH900102', 'QIAN880114', 'KHAG800101', 'CHOP780215', 'OOBM850102', 'WEBA780101', 'MITS020101']
...
summary.to_csv('bootstrap-lasso_SfromModel_.csv')
